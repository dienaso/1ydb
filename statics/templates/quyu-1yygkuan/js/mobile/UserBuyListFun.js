            ...
            function(q) {
                if (q.code == 0) {
                    ...
                    for (var p = 0; p < r; p++) {
                        ...
                        o += "<li onclick=\"location.href='"+Gobal.Webpath+"/mobile/home/userbuydetail/" + n[p].id + '\'"><a class="fl z-Limg">';
                        if (m == 1) {
                        ...
                        if (m == 1 || m == 2) {
                            ...
                            if (m == 3) {
                                o += '<p>获得者：' + n[p].q_user +'</p><p>揭晓时间：<em class="gray6">' + n[p].q_end_time + "</em></p>"
                            }
                        }
