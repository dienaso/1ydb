...
<form name="myform" action="" method="post" enctype="multipart/form-data">
  <table width="100%" cellspacing="0">
  	 <tr>
			...
			<td>
				<input type="text" name="f_overziliao" value="<?php echo $config['f_overziliao'];?>" class="input-text">(夺宝币)&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td>
				<input type="text" name="f_shoppay" value="<?php echo $config['f_shoppay'];?>" class="input-text">(夺宝币)&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td>
				<input type="text" name="f_phonecode" value="<?php echo $config['f_phonecode'];?>" class="input-text">(夺宝币)&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td>
				<input type="text" name="f_visituser" value="<?php echo $config['f_visituser'];?>" class="input-text">(夺宝币)&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td>
				<input type="text" name="fufen_yuan" value="<?php echo $config['fufen_yuan'];?>" class="input-text">(夺宝币/元)&nbsp;&nbsp;&nbsp;&nbsp;备注：夺宝币请输入10的整数
			</td>
		</tr>
		<tr>
