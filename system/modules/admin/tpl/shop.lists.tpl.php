...
<div class="header-data lr10">
	...
	<br/>
	<b>提示:</b> 因为商品添加后闪购码已经生成成功,所以不能在本期内修改价格了.
</div>
<div class="bk10"></div>
        ...
        <tbody>				
            ...
            <tr>
              <td align='center'><input name='listorders[<?php echo $v['id']; ?>]' type='text' size='3' value='<?php echo $v['order']; ?>' class='input-text-c'></td>  
				...
				[<a href="javascript:window.parent.Del('<?php echo G_ADMIN_PATH.'/'.ROUTE_C; ?>/goods_dels/<?php echo $v['id']; ?>', '是否删除?')" class="del_good">删除</a>]
				</td>
            </tr>
            <?php } ?>
        </tbody>
