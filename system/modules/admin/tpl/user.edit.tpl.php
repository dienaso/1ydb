...
<table width="100%" class="lr10">
    ...
    <tr>
    	<td>密码</td>
    	<td>
		<?php if($info['username']==system){ ?>
		系统服务无法修改
		<?php }else{ ?>
		<input type="password" name="password" class="input-text" id="password" value=""></input>
		<?php } ?>
		</td>
    </tr>
    <tr>
		...
		系统服务无法修改
		<?php }else{ ?>
		<input type="password" name="pwdconfirm" class="input-text" id="pwdconfirm" value=""></input>
		<?php } ?>
		</td>
    </tr>
    <tr>
