	...
	<div class="main">
		<div class="login-form">
		 ...
		 <form action="#" method="post" id="form">
				<input type="text" class="text" id="input-u" name="username" value="管理员账户" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '管理员账户';}" />
				<input type="password" id="input-p" name="password" value="******"  onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '******';}" />
				<div class="submit">
