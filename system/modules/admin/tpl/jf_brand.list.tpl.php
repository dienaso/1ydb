 ...
 <table width="100%" cellspacing="0">
   ...
   <tbody>
       ...
       <tr>
		 ...
		 <td align='center'>
         	[<a href="<?php echo G_ADMIN_PATH; ?>/jf_brand/edit/<?php echo $brand['id']; ?>">修改</a>]
            [<a href="<?php echo G_ADMIN_PATH; ?>/jf_brand/del/<?php echo $brand['id']; ?>">删除</a>]
         </td>
      </tr>
     <?php } ?>
   </table>
   ...
   <div class="btn_paixu">
  	<div style="width:80px; text-align:center;">
        ...
        onclick="myform.action='<?php echo G_MODULE_PATH; ?>/jf_brand/listorder/dosubmit';myform.submit();"/>
    </div>
  </div>
