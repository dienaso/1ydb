...
<!--start-->
		...
		<div class="dingdan_content">
			...
			<li><b class="api_b">剩余数量：</b><?php echo $shop['shenyurenshu']; ?> 人次	</li>
			<li><b class="api_b">总库存：</b><?php echo $shop['zongrenshu']; ?>人次 	</li>
			<li><b class="api_b">价格：</b><?php echo $shop['money']; ?></li>
			<div class="bk10"></div>
