    ...
    <tbody>
		<?php foreach($recordlist AS $v) {	?>
            <tr>
                ...
                <td align="center">
                <a  target="_blank" href="<?php echo WEB_PATH.'/jf_goods/'.$v['shopid']; ?>">
                ...
                <td align="center"><a href="<?php echo G_MODULE_PATH;?>/jf_dingdan/get_dingdan/<?php echo $v['id']; ?>">详细</a></td>
            </tr>
            <?php } ?>
  	</tbody>
</table>
