...
<div class="header-data lr10">
	<b>当前闪购基金总金额为 : <font color="red"><?php echo $config['fund_count_money']; ?></font> 元</b>
</div>
<div class="bk10"></div>
...
<table width="100%" class="lr10">
  ...
  <tr>
	...
	当您每参与1人次闪购，将出资 <font color="red"><?php echo $config['fund_money']; ?></font> 元为闪购基金筹款
	</td>
  </tr>
    <tr>
    <td>基金总金额</td>
