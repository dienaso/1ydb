...
<form name="myform" action=""  method="post">
  <table width="100%" cellspacing="0">
	...
	<tr>
		...
		<td><input type="radio" name="lotterytype" id="lotterytype1" value="1" class="input-text" <?php echo $arr[0]['lotterytype']==1?'checked':'';?>>夺宝币
	...
	<tr>
		...
		<td id="jbid2" style="<?php echo  $arr[0]['lotterytype']==3?'display:none':''?>"><input type="text" name="lotterjb" id="jf" class="input-text wid100" value="<?php echo $arr[0]['lotterjb'];?>">(夺宝币)</td>
	</tr>
	<tr>
