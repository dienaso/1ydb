...
<form name="myform" action=""  method="post">
  <table width="100%" cellspacing="0">
	...
	<tr>
		...
		<td>
			<input type="radio" name="lotterytype" id="lotterytype1" value="1" class="input-text" checked>夺宝币
	...
	<tr>
		...
		<td id="jbid2" ><input type="text" name="lotterjb" id="jf" class="input-text wid100" >(夺宝币)</td>
	</tr>
	<tr>
