<?php defined('G_IN_SYSTEM')or exit('No permission resources.'); ?><div class="subnav">
	<ul>
		...
		<?php if($tab=="userbuy"): ?>
		<li class="poa-4"><a class="cur">聚购记录<s></s></a></li>
		<?php  else: ?>
		<li class="poa-4"><a href="<?php echo WEB_PATH; ?>/userbuy/<?php echo idjia($member['uid']); ?>" >聚购记录<s></s></a></li>
		<?php endif; ?>
		...
		<li class="poa-2"><a href="<?php echo WEB_PATH; ?>/userpost/<?php echo idjia($member['uid']); ?>" >晒单<s></s></a></li>
		 -->
		<?php endif; ?>
		<!-- <li class="poa-4"><a href="http://u.1yyg.com/1000293094/UserBuy">聚购记录<s></s></a></li>
		<li class="poa-4"><a class="cur">获得的商品<s></s></a></li>
