...
<div class="left">
	<div class="head">
		<a href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($member['uid']); ?>" target="_blank">			
			<img id="imgUserPhoto" src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $member['img']; ?>_160160.<?php echo img($member['img']); ?>" width="160" height="160" border="0"/>			
		</a>
	</div>
	<div class="head-but">
	...
	<div class="sidebar-nav">
		...
		<h2 class="sid-icon01"><a href="<?php echo WEB_PATH; ?>/member/home"><b></b>会员中心</a></h2>
		<ul>
			<li class=""><a href="<?php echo WEB_PATH; ?>/member/home/modify">资料完善</a></li>
			<li class=""><a href="<?php echo WEB_PATH; ?>/member/home/password">修改密码</a></li>
			<li class=""><a href="<?php echo WEB_PATH; ?>/member/home/address">收货地址</a></li>
		</ul>
		<!--<p class="sid-line"></p>
		<h3 class="sid-icon09" ><a href="<?php echo WEB_PATH; ?>/member/home/modify"><b></b>个人设置</a></h3>		
		<p class="sid-line"></p> -->
		<h3 class="sid-icon02">
			<a href="javascript:void();"><b></b>我的聚购 <s title="收起"></s></a>
		</h3>
		<ul>
			<li class=""><a href="<?php echo WEB_PATH; ?>/member/home/userbuylist">聚购记录</a></li>
		...
		<p class="sid-line"></p>
		<h3 class="sid-icon07 sid-hcur" hasChild="0" url=""><a href="<?php echo WEB_PATH; ?>/member/home/userfufen"><b></b>我的夺宝币</a></h3>
